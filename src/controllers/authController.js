...
*/
export const signUpValidationController = catchAsync(async (req, res, next) => {
...
export const passwordResetController = catchAsync(async (req, res, next) => {
...
export const passwordResetConfirmationController = catchAsync(async (req, res, next) => {
